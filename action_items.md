...
| 2026-06-23 | — | Push security hardening to rebalancer_pro | Pradeep | Run `git push rebalancer master` — covers: Basic Auth on dashboards, at-rest Fernet encryption of broker data + Paytm tokens, security headers, loopback bind, server-version suppression |
